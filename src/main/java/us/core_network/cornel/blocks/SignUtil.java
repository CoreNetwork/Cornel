...
public class SignUtil
{
     ...
     * @param message Message on the sign, lines separated by <code>[NEWLINE]</code>.
     */
    ...
    {
        message = Messages.applyFormattingCodes(message);
    ...
    /**
     * Convenience method to quickly check if sign has any formatted text in it.
     * @param sign Sign to check.
     * @return <code>true</code> if sign has any formatted text.
     */
    public static boolean isSignFormatted(Sign sign)
    {
        String colorSymbol = "\u00A7";
